...
<img src="images/ip_dmsnr.png" width="50%">
...
| Модель | Recall | Precision | F1-Score | MCC | FN (Пропуски) |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Logistic Regression** | **0.920** | 0.799 | **0.855** | **0.842** | **26** |
| XGBoost | 0.920 | 0.731 | 0.813 | 0.799 | 27 |
